...
<html class="no-js">  
  <?php include('head.php'); ?>
    <body>
	 ...
	 <center><button type="submit" name="search">Search</button></center>
	...
	<div class="container-fluid">
       ...
       <div class="block">
						...
						<div class="get-touch-heading">
							<center><h2>View Student Record</h2> </center>
							</div>
...
echo "<td><img src='../Avani/images/". $row['image']."' width='50' height='50'></td>";
									?>
